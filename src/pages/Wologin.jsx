...
import image from "./img.jpg"
 function Wologin(){
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8080/login/worker', {username, password})
        .then(res => {
            console.log("login: " + res.data);
            if(res.data.Status === "Success") {
                   navigate(`/worker/${username}/${category}`);
                }
                else {
                  setusername('');
                  setPassword('');
    ...
    function hom(){
      ...
      return(
        ...
        <div className="title1">
            <img src={image} classNames="login-image"></img>
